    ...
    <section class="">
        <div class="container">
            <form action="" method="post" enctype="multipart/form-data"
                onsubmit="return confirmAction('edit printer information')">
                <div class=" row">
                    <div class="col-25">
                        <label for="printerID">Printer ID:</label>
                    </div>
                    <div class="col-75">
                        <input value="<?php echo $printer->printerID; ?>" type="text" id="printerID" name="printerID"
                            placeholder="Enter Printer ID" readonly>
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                        <input value="<?php echo $printer->printerModel; ?>" type="text" id="printerModel"
                            name="printerModel" placeholder="Enter Printer model">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                        <textarea id="subject" name="Description_D" placeholder="Write something.."
                            style="height:200px"><?php echo $printer->Description_D; ?></textarea>
                    </div>
                </div>
                <div class="row">
